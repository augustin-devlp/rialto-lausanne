 ...
 * nouveau worker ne s'installe, et la mise à jour silencieuse
 * (PwaRegister, activation à la navigation) n'a rien à activer. C'était
 * la cause racine du « front périmé » (commande R-2026-039 : écran
 * remisé, encaissement plein tarif).
 *
